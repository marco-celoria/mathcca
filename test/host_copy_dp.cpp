...
TEST(CopySp, BasicAssertions)
{
    ...
    std::size_t c{5};
    for (auto n= 1; n < 9; ++n) {
      mathcca::host_matrix<double> dA{r, c, static_cast<double>(n)};
      mathcca::host_matrix<double> dB{r, c, static_cast<double>(n+1)};
      mathcca::host_matrix<double> dC{r, c};
      mathcca::host_matrix<double> dD{r, c, static_cast<double>(n)};
      mathcca::host_matrix<double> dE{r, c, static_cast<double>(n+1)};
