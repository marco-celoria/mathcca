...
TEST(FillDp, BasicAssertions)
{
    ...
    for (auto n= 1; n < 9; ++n) {
      ...
      mathcca::host_matrix<double> X1{r, c};
      mathcca::host_matrix<double> X2{r, c};
      mathcca::host_matrix<double> X3{r, c};
      mathcca::host_matrix<double> X4{r, c};
      mathcca::host_matrix<double> X5{r, c};
      mathcca::host_matrix<double> X6{r, c};
      mathcca::host_matrix<double> X7{r, c};
      mathcca::host_matrix<double> X8{r, c};
