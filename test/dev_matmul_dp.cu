...
TEST(MatmulDp, BasicAssertions)
{
    ...
    std::size_t n{2};
    for (auto i= 1; i < 8; ++i) {
      mathcca::device_matrix<double> X0{l, m};
      mathcca::device_matrix<double> Y0{m, n};
      mathcca::device_matrix<double> B0{l, n};
      mathcca::device_matrix<double> T0{l, n};
      ...
      mathcca::matmul<value_type, mathcca::MM::Cublas, 8>(X0, Y0, C0, mathcca::MM::Cublas());
      auto C1 = mathcca::matmul<value_type, mathcca::MM::Cublas, 16>(X0, Y0, mathcca::MM::Cublas());
      auto C2 = mathcca::matmul<value_type, mathcca::MM::Cublas, 32>(X0, Y0, mathcca::MM::Cublas());
