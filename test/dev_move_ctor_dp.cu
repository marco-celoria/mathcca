...
TEST(MoveCtorDp, BasicAssertions)
{
  ...
  for (auto n= 1; n < 9; ++n) {
    ...
    mathcca::device_matrix<double> dD1{row, col};
    mathcca::host_matrix<double>   hD1{row, col};
    ...
    auto dC1{std::move(dB1)};
    auto dC2{std::move(dB2)};
    
    auto hC1{std::move(hB1)};
    auto hC2{std::move(hB2)};
