...
TEST(TransSp, BasicAssertions)
{
    ...
    for (auto i= 1; i < 8; ++i) {
      ...
      mathcca::device_matrix<float> Y{r, c};
      mathcca::device_matrix<float> Z{r, c};
      mathcca::device_matrix<float> X0{r, c};
      mathcca::device_matrix<float> Y0{r, c};
      mathcca::device_matrix<float> Z0{r, c};
      mathcca::device_matrix<float> B0{c, r};
      mathcca::device_matrix<float> T0{c, r};
      mathcca::device_matrix<float> C0{c, r};
