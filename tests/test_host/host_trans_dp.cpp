...
TEST(TransDp, BasicAssertions)
{
    ...
    for (auto i= 1; i < 9; ++i) {
      ...
      mathcca::host_matrix<value_type> Y{r, c};
      mathcca::host_matrix<value_type> Z{r, c};
      mathcca::host_matrix<value_type> X0{r, c};
      mathcca::host_matrix<value_type> Y0{r, c};
      mathcca::host_matrix<value_type> Z0{r, c};
      mathcca::host_matrix<value_type> B0{c, r};
      mathcca::host_matrix<value_type> T0{c, r};
      mathcca::host_matrix<value_type> C0{c, r};
      ...
      auto C2 = mathcca::transpose<decltype(Y),  mathcca::Trans::Mkl, 32>(Z,  mathcca::Trans::Mkl());
